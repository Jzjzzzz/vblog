...
-- ----------------------------
INSERT INTO `admin_user` VALUES (00000000001, 'admin', '5027d8df7ca9cc1b27ddedf29fb0ed5f', '18176702572', 'https://vue-vblog.oss-cn-shenzhen.aliyuncs.com/adminAvatar/2022/08/19/80b086d23aac408c95517bd5ebc4eea3.jpg', '2022-06-07 15:06:24', '2022-11-03 16:31:26', 'admin', 'I am a super administrator');
...
CREATE TABLE `item_bank`  (
  ...
  `answer` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '答案',
...
INSERT INTO `sys_dict_data` VALUES (152, 0, 'JUC', '0', 'sys_item_bank_type', NULL, 'primary', 'N', '0', 'admin', '2023-06-07 15:44:38', '', NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (153, 0, 'JVM', '1', 'sys_item_bank_type', NULL, 'primary', 'N', '0', 'admin', '2023-06-07 15:44:50', '', NULL, NULL);
...
INSERT INTO `sys_dict_type` VALUES (118, '题目类型', 'sys_item_bank_type', '0', 'admin', '2023-06-07 15:44:09', '', NULL, '题目类型');
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES (1, 'UniApp开发进度公告', '2', 0x3C703EE4B8AAE4BABAE58D9AE5AEA220556E6920417070E78988E69CACE5B7B2E58F91E5B8832CE9A1B9E79BAEE59CB0E59D802068747470733A2F2F6769746875622E636F6D2F4A7A6A7A7A7A7A2F76626C6F672CE585B3E6B3A8E8B79FE8B8AAE69C80E696B0E69BB4E696B0E8BF9BE5BAA6213C2F703E, '0', 'admin', '2023-09-07 07:41:12', '', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1122 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
